                ...
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <button style="margin-left:710px;" class="btn btn-sm btn-success" onclick="window.open('modul/mod_report/all_responden.php', '_blank')">
                                <span class="glyphicon glyphicon-zoom-in"></span> Rekap Semua Kuisioner
                            </button>
                        </div>
                    </div>
                    <div class="box-body">
                        <!-- Modal -->
                        <form action="grup_act.php" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="table-datatable">
                                ...
                                <tbody>
                                    ...
                                    include '../koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "SELECT * FROM responden ORDER BY id desc");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div id='kontentd'><a target='_blank' href='modul/mod_report/responden.php?act=detail&id=<?php echo $d['id']; ?>'>
                                                        <button class='btn btn-sm btn-success'><span class=\"glyphicon glyphicon-zoom-in\"></span> Detail</button></a>
                                                    <!-- <?php if ($_SESSION['level'] == "Super") { ?><a href='modul/mod_report/responden.php?act=hapus&id=<?php echo $data['id'] ?>'>
                                                ...
                                                <!-- <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_grup_<?php echo $d['id'] ?>">
