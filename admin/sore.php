...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">SORE CERIA (16:00-20:00)</li>
    </ol>
  </section>
      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">SORE CERIA (16:00-20:00)</h3>
          ...
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="sore_act.php" method="post">
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Tambah Data Jadwal Siaran sore</h5>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT * FROM sore");
                  while($d = mysqli_fetch_array($data)){
                    ?>
                    <tr>
                    <td><?php echo $no++; ?></td>
                      ...
                      <td>    
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_sore_<?php echo $d['id_sore'] ?>">
                        <i class="fa fa-cog"></i>
                      </button>

                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_sore_<?php echo $d['id_sore'] ?>">
                        <i class="fa fa-trash"></i>
                      </button>


                      <form action="sore_update.php" method="post">
                        <div class="modal fade" id="edit_sore_<?php echo $d['id_sore'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel">Edit Data sore</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                ...
                                <div class="form-group" style="width:100%;margin-bottom:20px">
                                  <label>Tanggal Siaran</label>
                                  <input type="hidden" name="id" value="<?php echo $d['id_sore'] ?>">
                      ...
                      <!-- modal hapus -->
                      <div class="modal fade" id="hapus_sore_<?php echo $d['id_sore'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                              <a href="sore_hapus.php?id=<?php echo $d['id_sore'] ?>" class="btn btn-primary">Hapus</a>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <form method="post" action="sore_report.php" enctype="multipart/form-data" class="p-3">
