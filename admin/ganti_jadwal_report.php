...
if (isset($_POST['tanggal_mulai']) && isset($_POST['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM ganti_jadwal WHERE tgl_pengajuan BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
...
<head>
    ...
    <title>Rekap Permohonan Pergantian Jadwal Penyiar</title>
    <style>
        @media print {
...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="centered-text">
            ...
            <h5>REKAP DATA PERMOHONAN PERGANTIAN JADWAL</h5>
        </div>
        <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo htmlspecialchars($row["tgl_pengajuan"]); ?></td>
                                <td><?php echo htmlspecialchars($row["nama_penyiar"]); ?></td>
                                <td><?php echo htmlspecialchars($row["dari_tanggal"]); ?></td>
                                <td><?php echo htmlspecialchars($row["menjadi_tanggal"]); ?></td>
                                <td><?php echo htmlspecialchars($row["dari_daypart"]); ?></td>
                                <td><?php echo htmlspecialchars($row["menjadi_daypart"]); ?></td>
                            </tr>
                        <?php $no++; } ?>
                    </tbody>
                </table>
