...
if (isset($_POST['tanggal_mulai']) && isset($_POST['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM interaksi WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
...
<head>
    ...
    <title>REKAP DATA INTERAKSI PENDENGAR</title>
    <style>
        @media print {
...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="centered-text">
            ...
            <h5>REKAP DATA INTERAKSI PENDENGAR</h5>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row["nama_pendengar"]); ?></td>
                                <td><?php echo htmlspecialchars($row["jenis_platform"]); ?></td>
                                <td><?php echo htmlspecialchars($row["interaksi"]); ?></td>
                            </tr>
                        <?php $no++; } ?>
                    </tbody>
                </table>
