...
if (isset($_POST['tanggal_mulai']) && isset($_POST['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM berita WHERE tgl_berita BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo htmlspecialchars($row["tgl_berita"]); ?></td>
                                <td><?php echo htmlspecialchars($row["tema"]); ?></td>
                                <td><?php echo htmlspecialchars($row["judul"]); ?></td>
                                <td><?php echo htmlspecialchars($row["sumber"]); ?></td>
                                <td><?php echo htmlspecialchars($row["berita_lengkap"]); ?></td>
                            </tr>
                        <?php $no++; } ?>
                    </tbody>
                </table>
