      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="malam_act.php" method="post">
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Tambah Data Jadwal Siaran malam</h5>
                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <td><?php echo $no++; ?></td>
                      ...
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_malam_<?php echo $d['id_malam'] ?>">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group" style="margin-bottom:15px;width: 100%">
                                  ...
                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    ...
                                    <select class="form-select form-control" name="nama_narasumber">
                                      <?php
                                      $data_user = mysqli_query($koneksi, "select * from narasumber");
                                      while ($user = mysqli_fetch_array($data_user)) {
                                        $selected = ($user['nama_narasumber'] == $d['nama_narasumber']) ? 'selected' : '';
                                        echo "<option value='{$user['nama_narasumber']}' {$selected}>{$user['nama_narasumber']}</option>";
                                      }
                                      ?>
                                    </select>
                                  </div>
                      ...
                      <!-- modal hapus -->
                      <div class="modal fade" id="hapus_malam_<?php echo $d['id_malam'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                              <a href="malam_hapus.php?id=<?php echo $d['id_malam'] ?>" class="btn btn-primary">Hapus</a>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <form method="post" action="malam_report.php" enctype="multipart/form-data" class="p-3">
