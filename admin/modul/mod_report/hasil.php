...
<nav class="navbar navbar-inverse">
	<ul class="nav navbar-nav">
		...
		<li class="<?php if ($_GET['sub'] == 'pergroup') {
						echo 'active';
					} ?>"><a href="?module=hasil&sub=pergroup">Grafik Per Group</a></li>
				...
				<div class="panel-body">
					...
					<script type="text/javascript">
						FusionCharts.ready(function() {
							new FusionCharts({
								type: 'column3d', // Use 'column3d' instead of 'MSColumn3D'
								renderAt: 'myHTMLTable<?php echo $data2['groupId']; ?>',
								width: '500',
								height: '300',
								dataFormat: 'htmltable',
								dataSource: "#myHTMLTable<?php echo $data2['groupId']; ?>" // Updated dataSource for modern syntax
							}).render();
						});
					</script>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="panel-title">
				...
				<button style="margin-left:710px;" class='btn btn-sm btn-success' value='Print All to Excel' onclick=location.href='modul/mod_report/all_responden.php'><span class="glyphicon glyphicon-zoom-in"></span> Rekap Semua Kuisioner</button>
			</div>
		</div>
