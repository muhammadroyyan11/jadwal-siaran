...
if (isset($_POST['tanggal']) && !empty($_POST['tanggal'])) {
    ...
    $query = "SELECT * FROM siang WHERE tanggal = '$tanggal'";
...
<head>
    ...
    <title>Rekap Jadwal Siaran</title>
    <style>
        @media print {
...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="centered-text">
            ...
            <h5>Jadwal Siaran SANTAI SIANG</h5>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td class="text-center"><?php echo $no; ?></td>
                                        ...
                                        <td><?php echo htmlspecialchars($row["topik"]); ?></td>
