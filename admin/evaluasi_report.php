...
if (isset($_POST['tanggal']) && !empty($_POST['tanggal'])) {
    ...
    $query = "
        SELECT * FROM evaluasi WHERE tgl_evaluasi = '$tanggal'
    ";
...
<head>
    ...
    <title>REKAP DATA EVALUASI KINERJA PENYIAR</title>
    <style>
        @media print {
...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="centered-text">
            ...
            <h5>REKAP DATA EVALUASI KINERJA PENYIAR HARIAN</h5>
        </div>
        <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo htmlspecialchars($row["tgl_evaluasi"]); ?></td>
                                <td><?php echo htmlspecialchars($row["daypart"]); ?></td>
                                <td><?php echo htmlspecialchars($row["nama_penyiar"]); ?></td>
                                <td><?php echo htmlspecialchars($row["evaluasi"]); ?></td>
