...
if (isset($_POST['tanggal_mulai']) && isset($_POST['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM jadwal_penyiar WHERE tgl_jadwal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
...
<head>
    ...
    <title>REKAP JADWAL PENYIAR</title>
    <style>
        @media print {
...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="centered-text">
            ...
            <h5>REKAP DATA JADWAL PENYIAR</h5>
        </div>
        <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo htmlspecialchars($row["tgl_jadwal"]); ?></td>
                                <td><?php echo htmlspecialchars($row["daypart1"]); ?></td>
                                <td><?php echo htmlspecialchars($row["daypart2"]); ?></td>
                                <td><?php echo htmlspecialchars($row["daypart3"]); ?></td>
                                <td><?php echo htmlspecialchars($row["daypart4"]); ?></td>
                            </tr>
                        <?php $no++; } ?>
                    </tbody>
                </table>
